...
from Predictors.HYBRID_SARIMA_LSTM import Hybrid_Predictor
                ...
                match args.model_type:
                    ...
                    case 'SARIMAX'|'SARIMA':   
                        ...
                        if args.run_mode == 'train_test':
                            ...
                            save_buffer(folder_path, train, args.target_column, size = buffer_size, file_name = 'buffer.json')
                        # Save training data
                        sarima.save_model(folder_path)
                    
                    case 'LSTM':
                        model = lstm.train_model()   
                        # Save the model 
                        #lstm.save_model(folder_path)                    
